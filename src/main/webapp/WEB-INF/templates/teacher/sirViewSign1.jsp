...
<div class="page-inner">
    ...
    <div class='left'>
        ...
        <ul class='banner'>
            <li style='left:0;'>
                ...
                <div class="item">
                    ...
                    <div class="item-list">
                        ...
                        <div class="data">
                            <span>${chuqin.key}</span>
                            <span class="num">${chuqin.value}</span>
                        </div>
                        <input  name="chuqininput" type="text" class="status" value="出勤" id="chuqin${status.index}"
                            <%--onclick="updatetype($('#chuqin${status.index}'))"--%>
                                $('#chuqin${status.index}').on("click", function () {
                        $("#chuqin${status.index}").select("open");
                        })
                        >
                    </div>
            ...
            <li>
                <div class="people">
                    迟到共<span>${chidaonum}</span>人
                </div>
                <div class="item">
                    <c:forEach items="${chidaos}" var="chuqin" varStatus="status">
                    <div class="item-list">
            ...
            <li>
                <div class="people">
                    缺勤共<span>${queqinnum}</span>人
                </div>
                <div class="item">
                    <c:forEach items="${queqins}" var="chuqin" varStatus="status">
                    <div class="item-list">
                        <img src="../img/student/touxiang.jpg" class="touxiang" alt="">
                        <div class="data">
                            <span>${chuqin.key}</span>
            ...
            <li>
                <div class="people">
                    请假共<span>${qinjianum}</span>人
                </div>
                <div class="item">
                    <c:forEach items="${qinjias}" var="chuqin" varStatus="status">
                    <div class="item-list">
                        <img src="../img/student/touxiang.jpg" class="touxiang" alt="">
                        <div class="data">
                            <span>${chuqin.key}</span>
