...
<head lang="en">
    ...
    <style type="text/css">
        ...
        .course-main-list .type ul li .type-name {
            font-size: 12px;
            height: 3vh;
            line-height: 3vh;
        }

        .course-main-list .type ul li .type-num {
            height: 4vh;
            line-height: 4vh;
        }
    ...
    <div class="workspace">
        <div id="host-box">
            <div class="content" id="null-div">
                <c:forEach items="${simsAttendNumEveryStus}" var="stu" varStatus="status">
                <div class="course-main-list" id="course-list">
                    <img src="../img/student/touxiang.jpg" class="touxiang">
                    <div class="data">
                        <div class="data-name">${stu.getStudentName()}</div>
                        <div class="data-num">${stu.getStudentNo()}</div>
                    </div>
                    <div class="type">
                        <ul>
