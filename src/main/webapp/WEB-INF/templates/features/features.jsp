...
<div class="page-inner" id="page-main-view">
    ...
    <%--<form id="userClassForm" action="getUserCoursePage" method="post">--%>
        ...
        <%--<footer class="fs24 footmenu">--%>
            ...
            <%--<a id="fuctionA" onfocus="clickFuction()" onblur="unClickFuction()" href="javascript:document:myselfForm.submit();">--%>
                <%--<div class="navSelf">--%>
                    <%--<i class="iconfont bold">--%>
                        <%--<img onfocus="this.blur()" id="imgFuction" src="../img/common/fuction1.png"--%>
