...
public class CourseController {
     ...
     */
    @RequestMapping(value = "/getUserCoursePage",method = {RequestMethod.POST, RequestMethod.GET})
    ...
    public String getSirClass(HttpServletRequest request, Model model) {
        ...
        List<SimsCourseInfo> courseList = getSirCourseList(request);
    ...
    public String getSirId(HttpServletRequest request){
        SimsUserInfo teacher = (SimsUserInfo) request.getSession().getAttribute("user");
        String sirID = teacher.getUserId();
        return sirID;
    }
     ...
     */
    public List<SimsCourseInfo> getSirCourseList(HttpServletRequest request) {
        String sirID = getSirId(request);
        List<SimsCourseInfo> teacherCourses = smisTeacherCourseService.selectTeacherCourseList(sirID);
    ...
    public String getStuClass(HttpServletRequest request, Model model) {
        ...
        List<SimsStudentCourseInfo> stuclass=smisStudentCourseInfoService.selectCoursecodeByStuNoList(student.getUserId());
