...
/** --------------------------------------------邮箱设置业务 -------------------------------------------------**/
    ...
    public String basicInfo(HttpServletRequest request, Model model) {
        ...
        if (RoleUtills.TEACHER.equalsIgnoreCase(role)) {
            ...
            model.addAttribute("userID", teacher.getUserId());
            model.addAttribute("email", "");
            model.addAttribute("name", teacher.getUserName());
            model.addAttribute("school", teacher.getPartment());
            ...
            model.addAttribute("school", student.getPartment());
            model.addAttribute("classNo", "");
